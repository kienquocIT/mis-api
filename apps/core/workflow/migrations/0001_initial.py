    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collab_in_form', jsonfield.fields.JSONField(default={}, help_text='use for option in form')),
                ('collab_out_form', jsonfield.fields.JSONField(default={}, help_text='use for option out form')),
                ('collab_in_workflow', jsonfield.fields.JSONField(default=[], help_text='use for option in workflow')),
                ('zone_initial_node', jsonfield.fields.JSONField(default=[], help_text='list zones of initial node', verbose_name='zone')),
                ('order', models.IntegerField(null=True)),
