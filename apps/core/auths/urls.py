...
from .views import (
    AuthLogin, AuthRefreshLogin, MyProfile, SwitchCompanyView,
    MyLanguageView, ChangePasswordView, ForgotPasswordView, ForgotPasswordDetailView, AuthLogout,
)
from .views_2fa import TwoFAIntegrate, TwoFAIntegrateDetail, TwoFA
from .views_home import AliveCheckView, AuthLogsView, AuthLogReport, CalendarByDay
...
urlpatterns = [
    ...
    path('calendar', CalendarByDay.as_view(), name='CalendarByDay'),
]
