...
from apps.accounting.accountingsettings.models.product_account_determination import ProductAccountDetermination
from apps.accounting.accountingsettings.serializers.product_account_determination import (
