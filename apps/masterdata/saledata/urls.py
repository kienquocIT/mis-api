...
from apps.masterdata.saledata.views.warehouse import ProductWareHouseLotList
...
urlpatterns += [
    ...
    # path('warehouses-serials', ProductWareHouseList.as_view(), name='ProductWareHouseList'),
    path(
