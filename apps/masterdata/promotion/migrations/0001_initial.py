    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('before_after_tax', models.BooleanField(default=True, help_text='Option check before or after tax', verbose_name='Before After tax check')),
                ('percent_fix_amount', models.BooleanField(default=True, help_text='Option check before or after tax', verbose_name='Percent or Fixed amount')),
                ('fix_value', models.IntegerField(blank=True, help_text='This field is required when user check "percent fix amount" field is False', null=True, verbose_name='Fixed amount')),
                ...
                ('is_on_order', models.BooleanField(default=False, verbose_name='Discount on order')),
                ('is_minimum', models.BooleanField(default=False, verbose_name='Minimum purchase')),
                ('minimum_value', models.FloatField(blank=True, null=True, verbose_name='Minimum purchase value')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_type', models.IntegerField(help_text='filter customer by option choose (0: all, 1: choose customer, 2: filter by condition)', verbose_name='Customer type')),
                ...
                ('is_discount', models.BooleanField(blank=True, help_text='Promotion for discount', null=True, verbose_name='Discount check')),
                ('is_coupons', models.BooleanField(blank=True, help_text='Promotion for Coupons', null=True, verbose_name='Coupons check')),
                ('is_gift', models.BooleanField(blank=True, help_text='Promotion for gift', null=True, verbose_name='Gift check')),
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_by_list_promotion', to='base.currency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_by_list_customer', to='hr.employee')),
                ('promotion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_by_list_promotion', to='promotion.promotion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(help_text='Customer property type field for format result field purpose.', max_length=50, verbose_name='Customer property type')),
                ('logic', models.CharField(help_text='Logic between condition for connect 2 or many condition purpose', max_length=50, verbose_name='Logic')),
