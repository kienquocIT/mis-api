...
AppProp_SaleData_Quotation_data = {
    ...
    '47e31f9e-69a3-4b69-ada3-ce777c420864': {
        'application_id': 'b9650500-aba7-44e3-b6e0-2542622702a3',
        'title': 'Product',
        'code': 'quotation_products_data__product_data__title',
        'type': 5,
    ...
    '42cc882b-15af-4034-b8a1-0d8d6038d537': {
        'application_id': 'b9650500-aba7-44e3-b6e0-2542622702a3',
        'title': 'Product type',
        'code': 'quotation_products_data__product_data__general_information__product_type__title',
        'type': 5,
...
AppProp_SaleData_SaleOrder_data = {
    ...
    'de2717ad-b461-4b7a-a29c-63baf1e0f632': {
        'application_id': 'a870e392-9ad2-4fe2-9baa-298a38691cf2',
        'title': 'Product',
        'code': 'sale_order_products_data__product_data__title',
        'type': 5,
        'content_type': 'saledata.product',
        'is_wf_zone': False,
        'is_wf_condition': True,
    ...
    'ded465fa-2ed9-48a8-9e70-ba72e8a011d2': {
        'application_id': 'a870e392-9ad2-4fe2-9baa-298a38691cf2',
        'title': 'Product type',
        'code': 'sale_order_products_data__product_data__general_information__product_type__title',
        'type': 5,
        'content_type': 'saledata.producttype',
        'is_wf_zone': False,
        'is_wf_condition': True,
...
AppProp_SaleData_LeaseOrder_data = {
    # 010404b3-bb91-4b24-9538-075f5f00ef14 # leaseorder.LeaseOrder
    # General fields
    '87fa759c-e90e-4026-b81f-626668400b9d': {
    ...
    'be165351-dd92-4c66-98f0-ce99f2701e7a': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Contact',
        'code': 'contact',
        'type': 5,
    ...
    # Totals of products
    '852edb01-f4a9-4c34-9837-67a63d46f9f1': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total product pretax amount',
        'code': 'total_product_pretax_amount',
        'remark': 'Total product pretax amount of sale order',
    ...
    'a38e759f-8303-4cd6-ad57-5ffd63630e63': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total product discount rate',
        'code': 'total_product_discount_rate',
        'remark': 'Total product discount rate of sale order',
    ...
    '16f6fc80-1586-4adb-8360-18f0ce828382': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total product discount',
        'code': 'total_product_discount',
        'remark': 'Total product discount of sale order',
    ...
    'b718aef9-453e-4ebd-9a41-2f6a3b5e9f59': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total product tax',
        'code': 'total_product_tax',
        'remark': 'Total product tax of sale order',
    ...
    '75004ede-e612-412e-b6cf-07631dbf32e9': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total product',
        'code': 'total_product',
        'remark': 'Total product of sale order',
    ...
    '37815685-3e15-423f-af17-83876a5ecd17': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total product revenue before tax',
        'code': 'total_product_revenue_before_tax',
        'remark': 'Total product revenue before tax of sale order',
    ...
    # Totals of costs
    '5368355a-c7ed-46f9-aa1a-77cd8af477a3': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total cost pretax amount',
        'code': 'total_cost_pretax_amount',
        'remark': 'Total cost pretax amount of sale order',
    ...
    '9369c242-ec8e-4d8e-84ea-181f21bc5afe': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total cost tax',
        'code': 'total_cost_tax',
        'remark': 'Total cost tax of sale order',
    ...
    'b6751ceb-c648-454a-8f92-a4ed415004d8': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total cost',
        'code': 'total_cost',
        'remark': 'Total cost of sale order',
    ...
    # Totals of expenses
    '44dea2d6-c90f-47ff-915c-ce6c0a534782': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total expense pretax amount',
        'code': 'total_expense_pretax_amount',
        'remark': 'Total expense pretax amount of sale order',
    ...
    'bf341f7a-a704-4d97-ace7-f153bd199cd6': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total expense tax',
        'code': 'total_expense_tax',
        'remark': 'Total expense tax of sale order',
    ...
    'ec2f3b46-ed7e-4f4f-b3f2-4fe1764817da': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total expense',
        'code': 'total_expense',
        'remark': 'Total expense of sale order',
    ...
    # WORKFLOW
    'd87aa1bb-31ac-487e-90e1-4718a63061ab': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Title',
        'code': 'title',
        'type': 1,
    ...
    '32b8e285-5af5-4ad3-9f6e-ccfa75f32770': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Industry',
        'code': 'customer_data__industry__id',
        'type': 5,
    ...
    '49996f97-0e6f-42e0-8ccd-8aa339200053': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product information',
        'code': 'lease_products_data',
        'remark': 'Tab line detail of lease order',
        'code_related': [
            'total_product_pretax_amount', 'total_product_discount_rate',
            'total_product_discount', 'total_product_tax',
            'total_product', 'total_product_revenue_before_tax',
            'lease_costs_data', 'lease_indicators_data',
            'total_cost_pretax_amount', 'total_cost_tax', 'total_cost',
        ],
        'type': 1,
        'is_wf_zone': True,
    ...
    '052b7547-c65e-4a8f-b47a-b1f8aa88c895': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Logistic information',
        'code': 'lease_logistic_data',
        'remark': 'Tab logistic of lease order',
        'type': 1,
        'is_wf_zone': True,
        'is_wf_condition': False,
    },
    'd9d3527e-8c53-4513-87bb-e0b5162d827c': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Cost information',
        'code': 'lease_costs_data',
        'remark': 'Tab cost of lease order',
        'code_related': [
            'total_cost_pretax_amount', 'total_cost_tax',
            'total_cost', 'lease_indicators_data',
        ],
        'type': 1,
        'is_wf_zone': True,
        'is_wf_condition': False,
    },
    '0239bcb0-e2cb-4be1-937e-30f690146762': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Expense information',
        'code': 'lease_expenses_data',
        'remark': 'Tab expense of lease order',
        'code_related': [
            'total_expense_pretax_amount', 'total_expense_tax',
            'total_expense', 'lease_indicators_data',
        ],
        'type': 1,
        'is_wf_zone': True,
        'is_wf_condition': False,
    },
    '2dc2d42a-0f0d-4c14-a744-3ebaf878890d': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Indicator information',
        'code': 'lease_indicators_data',
        'remark': 'Tab indicator of lease order',
        'type': 1,
        'is_wf_zone': True,
        'is_wf_condition': False,
    },
    '8bbc9ff3-bc5e-424b-a45f-9e445bcb3c29': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product',
        'code': 'lease_products_data__product_data__title',
        'type': 5,
        'content_type': 'saledata.product',
        'is_wf_zone': False,
        'is_wf_condition': True,
    },
    '01f2da5e-de21-414b-a8bd-e68266b3067b': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product type',
        'code': 'lease_products_data__product_data__general_information__product_type__title',
        'type': 5,
        'content_type': 'saledata.producttype',
        'is_wf_zone': False,
        'is_wf_condition': True,
    },
    '12f37590-6982-4185-b301-c6d10df131c5': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product subtotal',
        'code': 'lease_products_data__product_subtotal_price',
        'remark': 'Thành tiền của một dòng sản phẩm',
        'type': 6,
        'example': 'prop(Product subtotal)',
        'is_wf_condition': True,
    },
    'f558e114-1ef3-48ac-ba40-7d2952cec26b': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Expense',
        'code': 'lease_expenses_data__expense_item_data__title',
        'type': 5,
        'content_type': 'saledata.expenseitem',
        'is_wf_zone': False,
        'is_wf_condition': True,
    },
    'e2158abf-3e04-4383-b23a-7bbb2ed0ed55': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Labor',
        'code': 'lease_expenses_data__expense_data__title',
        'type': 5,
        'content_type': 'saledata.expense',
        'is_wf_zone': False,
        'is_wf_condition': True,
    },
    '0272dea7-82f9-49cb-9a6d-719f8d6129a1': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Expense subtotal',
        'code': 'lease_expenses_data__expense_subtotal_price',
        'remark': 'Thành tiền của một dòng chi phí',
        'type': 6,
        'example': 'prop(Expense subtotal)',
        'is_wf_condition': True,
    },
    '78210f95-c005-4c2d-ab1d-3e7e75127a6f': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Revenue',
        'code': 'indicator_revenue',
        'remark': 'Indicator revenue of lease order',
        'type': 6,
        'is_wf_zone': False,
        'is_wf_condition': True,
    },
    '01bc3e9c-98c1-429f-b351-33d020c63754': {
        ...
        'title': 'Gross profit',
        'code': 'indicator_gross_profit',
        'remark': 'Indicator gross profit of lease order',
        'type': 6,
        'is_wf_zone': False,
        'is_wf_condition': True,
    },
    '83ea9445-1190-4c4b-a5ba-3f14927389e8': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Net income',
        'code': 'indicator_net_income',
        'remark': 'Indicator net income of lease order',
        'type': 6,
        'is_wf_zone': False,
        'is_wf_condition': True,
    },
    # INDICATOR
    '539945e1-0088-4c3b-89c4-0481d6244c2c': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product',
        'code': 'product_data__title',
        'remark': 'Sản phẩm trong thông tin tab sản phẩm',
    ...
    'cab6de0b-72d2-473c-acf5-19f57044021d': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product type',
        'code': 'product_data__general_information__product_type__title',
        'remark': 'Loại sản phẩm trong thông tin tab sản phẩm',
    ...
    '050c029d-231b-41ce-99dc-8cc3f4927136': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product category',
        'code': 'product_data__general_information__product_category__title',
        'remark': 'Danh mục sản phẩm trong thông tin tab sản phẩm',
    ...
    'e1b39337-32c9-47b9-8d41-ac899cb22e06': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product quantity',
        'code': 'product_quantity',
        'remark': 'Số lượng của một dòng sản phẩm',
    ...
    '45ba1dcf-e75b-4f95-9e10-c93f33553a1d': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product unit price',
        'code': 'product_unit_price',
        'remark': 'Đơn giá của một dòng sản phẩm',
    ...
    '7236179a-1aec-4897-a916-884192432b9b': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Product subtotal',
        'code': 'product_subtotal_price',
        'remark': 'Thành tiền của một dòng sản phẩm',
    ...
    'f6c9b6c7-9122-40e4-a667-02a8e773dd44': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Expense type',
        'code': 'expense_item_data__title',
        'remark': 'Loại chi phí trong thông tin tab chi phí',
    ...
    '5bb2bb24-9030-4dec-a275-e3cb3caa42c6': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Labor expense type',
        'code': 'expense_data__title',
        'remark': 'Loại chi phí nhân công trong thông tin tab chi phí',
    ...
    'e2d29276-2cfe-4721-b7a5-418c7ce6571a': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Expense quantity',
        'code': 'expense_quantity',
        'remark': 'Số lượng của một dòng chi phí',
    ...
    '7e0cab27-a62c-4ee3-8aed-874e54863931': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Expense unit price',
        'code': 'expense_price',
        'remark': 'Đơn giá của một dòng chi phí',
    ...
    'a425475e-5aee-4baf-ac9d-6f2da57a4ead': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Expense subtotal before tax',
        'code': 'expense_subtotal_price',
        'remark': 'Thành tiền của một dòng chi phí',
    ...
    '99504079-4428-4992-9528-553d8eb006e9': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Expense subtotal after tax',
        'code': 'expense_subtotal_price_after_tax',
        'remark': 'Thành tiền sau thuế của một dòng chi phí',
    ...
    '9f849ea3-b442-4b27-abc2-4fbd4ef57451': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total revenue after tax',
        'code': 'total_product',
        'remark': 'Total revenue of lease order',
        'type': 6,
        'is_sale_indicator': True,
        'date_created': '2025-01-01 00:00:05',
    },
    'b85a114a-014f-4e87-92c7-11e3127f99f0': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total cost after tax',
        'code': 'total_cost',
        'remark': 'Total cost of lease order',
        'type': 6,
        'is_sale_indicator': True,
        'date_created': '2025-01-01 00:00:04',
    },
    'd00cadcb-506a-4947-9d9a-75f99ab984c5': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total expense after tax',
        'code': 'total_expense',
        'remark': 'Total expense of lease order',
        'type': 6,
        'is_sale_indicator': True,
        'date_created': '2025-01-01 00:00:03',
    },
    '2764ea85-ba06-4670-a556-712a2f49c823': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total revenue before tax',
        'code': 'total_product_revenue_before_tax',
        'remark': 'Total revenue before tax of lease order (after discount on total, apply promotion,...)',
        'type': 6,
        'is_sale_indicator': True,
        'date_created': '2025-01-01 00:00:02',
    },
    'dd45cffd-90ef-4d53-b5c6-989dcd48fc90': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total cost before tax',
        'code': 'total_cost_pretax_amount',
        'remark': 'Total cost before tax of lease order',
        'type': 6,
        'is_sale_indicator': True,
        'date_created': '2025-01-01 00:00:01',
    },
    '7bea58d1-12f7-4937-a6d7-af5041fef89e': {
        'application_id': '010404b3-bb91-4b24-9538-075f5f00ef14',
        'title': 'Total expense before tax',
        'code': 'total_expense_pretax_amount',
        'remark': 'Total expense before tax of lease order',
        'type': 6,
        'is_sale_indicator': True,
        'date_created': '2025-01-01 00:00:00',
    },
