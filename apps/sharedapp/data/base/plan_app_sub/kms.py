...
KMS_INCOMING_DOCUMENT = {
    "id": "6944d486-66a0-4521-bd28-681d5df42ff3",
    "title": "Incoming document",
    "code": "kmsincomingdocument",
    "model_code": "kmsincomingdocument",
    "app_label": "incomingdocument",
    "is_workflow": True,
    "allow_permit": True,
    "option_permission": 0,
    "option_allowed": [1, 2, 3, 4],
...
Application_kms_data = {
    ...
    "6944d486-66a0-4521-bd28-681d5df42ff3": ApplicationConfigFrame(**KMS_INCOMING_DOCUMENT).data(
        depend_follow_main=False,
        filtering_inheritor=True
    ),
}
