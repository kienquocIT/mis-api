...
class GRFromPMHandler:
    ...
    def setup_product_sub_for_representative_product_modified(
            cls, pm_obj, new_logs, re_product_obj, re_prd_prd_wh_obj, re_prd_prd_wh_lot_obj, re_prd_prd_wh_serial_obj
    ):
    ...
    @classmethod
    def setup_product_sub_for_product_modified(cls, pm_obj, new_logs):
        if pm_obj.product_modified and new_logs:
            uom_obj = None
            product_modified_value = 0
            value_plus = 0
    ...
    def setup_product(cls, pm_obj, issue_data, re_prd_prd_wh_obj, re_prd_prd_wh_lot_obj, re_prd_prd_wh_serial_obj):
        ...
        if re_product_obj:
            return cls.setup_product_sub_for_representative_product_modified(
                pm_obj, new_logs, re_product_obj, re_prd_prd_wh_obj, re_prd_prd_wh_lot_obj, re_prd_prd_wh_serial_obj
            )
        return cls.setup_product_sub_for_product_modified(pm_obj, new_logs)
