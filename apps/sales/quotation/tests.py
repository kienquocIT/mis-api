...
class TestCaseQuotation(AdvanceTestCase):
    def setUp(self):
        self.maxDiff = None
    ...
    def test_create_quotation(self):
        ...
        data_account_group = {  # noqa
            "code": "AG01QUOTATION",
            "title": "Nhóm khách hàng test báo giá",
            "description": ""
        }
            ...
            "quotation_products_data": [
                {
                    ...
                    "product_code": "002",
                    "unit_of_measure_id": unit_of_measure.data['result']['id'],
                    "product_uom_title": "Cái",
                    "product_uom_code": "001",
                    "tax_id": tax_code.data['result']['id'],
