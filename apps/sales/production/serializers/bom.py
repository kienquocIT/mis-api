...
class BOMCreateSerializer(AbstractCreateSerializerModel):
    ...
    def create(self, validated_data):
        ...
        del validated_data['bom_process_data']
        del validated_data['bom_summary_process_data']
        del validated_data['bom_material_component_data']
        del validated_data['bom_tool_data']
