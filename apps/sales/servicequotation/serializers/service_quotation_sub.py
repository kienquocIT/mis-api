...
__all__ = [
    'ServiceQuotationServiceDetailSerializer',
    'ServiceQuotationWorkOrderSerializer',
    'ServiceQuotationShipmentSerializer',
    'ServiceQuotationExpenseSerializer',
    'ServiceQuotationPaymentSerializer'
]


# SERVICE DETAIL
class ServiceQuotationServiceDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ServiceQuotationServiceDetail
        fields = (
            'id',
            'product',
            'order',
...
# WORK ORDER
class ServiceQuotationWorkOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ServiceQuotationWorkOrder
        fields = (
            'product',
            'order',
            'code',
...
# SHIPMENT
class ServiceQuotationShipmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ServiceQuotationShipment
        fields = (
            'id',
            'code',
            'title',
...
# EXPENSE
class ServiceQuotationExpenseSerializer(serializers.ModelSerializer):
...
# PAYMENT
class ServiceQuotationPaymentSerializer(serializers.ModelSerializer):
    payment_detail_data = serializers.JSONField(required=False)
    reconcile_data = serializers.JSONField()

    class Meta:
        model = ServiceQuotationPayment
        fields = (
            'installment',
            'description',
            'payment_type',
