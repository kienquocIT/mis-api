...
#         data = {
#             "title": "PR 1",
#             "supplier": str(supplier.data['result']['id']),
#             "contact": str(supplier.data['result']['owner']['id']),
#             "request_for": 1,
#             "sale_order": None,
#             "delivered_date": '2023-10-10 11:21:00.000000',
#             "purchase_status": 0,
#             "note": "None",
...
#                     "quantity": 4,
#                     "unit_price": 20000000,
#                     "tax": product.data['result']['sale_information']['tax_code']['id'],
#                     "sub_total_price": 80000000
#                 }
#             ],
#             "pretax_amount": 80000000,
#             "taxes": 8000000,
#             "total_price": 88000000
#         }
#
#         url = reverse("PurchaseRequestList")
#         response = self.client.post(url, data, format='json')
#         # response.data = json.loads(json.dumps(response.data, default=self.convert_proxy_to_str))
#
#         # self.assertResponseList(
#         #     response,
#         #     status_code=status.HTTP_201_CREATED,
