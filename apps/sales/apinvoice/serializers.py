            ...
            response = requests.post(
                ...
                json={
                    "XmlData": "<Invoices>"
                               "<Inv>"
                               "<Invoice>"
                               "<Ikey>9333bd4a-3c94-4872-9411-2723acbb8f78</Ikey>"
                               "<CusCode>BB2021</CusCode>"
                               "<Buyer>System Admin</Buyer>"
                               "<CusName>Công ty Biển Bạc</CusName>"
                               "<Email>bienbac2021fake@gmail.com</Email>"
                               "<EmailCC></EmailCC>"
                               "<CusAddress>Số 12/13/14/15 toà nhà ABC, quận 3, TPHCM</CusAddress>"
                               "<CusBankName>MB Bank</CusBankName>"
                               "<CusBankNo>860860888999</CusBankNo>"
                               "<CusPhone>0123456789</CusPhone>"
                               ...
                               "<ProdQuantity>4</ProdQuantity>"
                               "<ProdPrice>38400000</ProdPrice>"
                               "<Discount>2</Discount>"
                               "<DiscountAmount>3072000</DiscountAmount>"
                               "<Total>153600000</Total>"
                               "<VATRate>10</VATRate>"
                               "<VATRateOther/>"
                               "<Amount>165580800</Amount>"
                               "<Extra></Extra>"
                               "</Product>"
                               "<Product>"
                               "<Code></Code>"
                               "<No></No>"
                               "<Feature>3</Feature>"
                               "<ProdName>Chiết khấu 2% khi mua đủ 4 cái (cho sản phẩm trên)</ProdName>"
                               "<ProdUnit></ProdUnit>"
                               ...
                               "<VATRate></VATRate>"
                               "<VATRateOther/>"
                               "<Amount>3072000</Amount>"
                               "<Extra></Extra>"
                               "</Product>"
                               "<Product>"
                               "<Code>CANON EOS R6</Code>"
                               "<No>2</No>"
                               "<Feature>1</Feature>"
                               "<ProdName>Máy ảnh Canon EOS R6 Mark II Kit RF24-105mm F4 L IS USM</ProdName>"
                               "<ProdUnit>Cái</ProdUnit>"
                               "<ProdQuantity>4</ProdQuantity>"
                               "<ProdPrice>70000000</ProdPrice>"
                               "<Discount>1</Discount>"
                               "<DiscountAmount>2800000</DiscountAmount>"
                               "<Total>280000000</Total>"
                               "<VATRate>10</VATRate>"
                               "<VATRateOther/>"
                               "<Amount>304920000</Amount>"
                               "<Extra></Extra>"
                               "</Product>"
                               "<Product>"
                               "<Code></Code>"
                               "<No></No>"
                               "<Feature>3</Feature>"
                               "<ProdName>Chiết khấu 1% khi mua đủ 4 cái (cho sản phẩm trên)</ProdName>"
                               "<ProdUnit></ProdUnit>"
                               "<ProdQuantity></ProdQuantity>"
                               "<ProdPrice></ProdPrice>"
                               "<Discount></Discount>"
                               ...
                               "<VATRate></VATRate>"
                               "<VATRateOther/>"
                               "<Amount>2800000</Amount>"
                               "<Extra></Extra>"
                               "</Product>"
                               "</Products>"
                               "<Total>427728000</Total>"
                               "<VATAmount>42772800</VATAmount>"
                               "<VATRateOther/>"
                               "<Amount>470500800</Amount>"
                               "<AmountInWords>Bốn trăm bảy mươi triệu năm trăm ngàn tám trăm đồng</AmountInWords>"
                               "</Invoice>"
                               "</Inv>"
                               "</Invoices>",
                    "Pattern": "1C24TMT",
