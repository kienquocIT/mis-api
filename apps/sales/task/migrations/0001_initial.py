# Generated by Django 4.1.3 on 2023-07-11 17:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attach', models.JSONField(default=list, help_text='["attachment_id1", "attachment_id2"]', null=True, verbose_name='attachment file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('out_assign_opt', models.IntegerField(choices=[(0, 'None'), (1, 'only member in dept'), (2, 'only staff in dept')], default=0, verbose_name='option assign out opp/pro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('attachment', models.FileField(upload_to='', verbose_name='Attachment file')),
