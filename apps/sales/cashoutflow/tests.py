...
from apps.masterdata.saledata.tests import IndustryTestCase, ProductTestCase
    ...
    def test_ap_list(self):
        ...
        self.assertCountEqual(
            ...
            [
                ...
                'sale_order_mapped', 'quotation_mapped', 'opportunity_mapped', 'expense_items', 'opportunity_id',
            ],
            check_sum_second=True,
        )
        return response
...
class PaymentTestCase(AdvanceTestCase):
    ...
    def test_payment_list(self):
        ...
        self.assertCountEqual(
            response.data['result'][0],
            [
                'id', 'code', 'title', 'sale_code_type', 'supplier', 'method', 'creator_name', 'beneficiary',
                'converted_value_list', 'return_value_list', 'payment_value', 'date_created'
            ],
            check_sum_second=True,
        )
        return response
...
#                     'quantity': 1,
#                     'tax_id': product.data['result']['sale_information']['tax']['id'],
#                     'unit_of_measure_id': product.data['result']['sale_information']['default_uom']['uom_id'],
#                     'unit_price': 20000000,
#                     'tax_price': 2000000,
#                     'subtotal_price': 20000000,
#                     'after_tax_price': 22000000,
#                 }
#             ]
#         }
#         response = self.client.post(url, data, format='json')
...
#         cost_data = []
#         return_total = 0
#         for item in advance_payment.data['result']['product_items']:
#             cost_data.append(
#                 {
