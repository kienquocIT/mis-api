...
class ContactTest(TestCase):
    def test_create_contact(self):
        ...
        self.assertEqual(contact.owner, employee)
        self.assertEqual(contact.bio, "03/11/2001")
        self.assertEqual(contact.salutation, salutation)
        self.assertEqual(contact.fullname, "Nguyen Thi Hong")
        self.assertEqual(contact.phone, "0987654321")
        self.assertEqual(contact.mobile, "0123456789")
        self.assertEqual(contact.email, "nguyenthihong@gmail.com")
        self.assertEqual(contact.job_title, "Manager")
        self.assertEqual(contact.address_infor, {"home_address": "Số 10/67, Xã Đức Lân, Huyện Mộ Đức, Quảng Ngãi", "work_address": "Số 22/20, Thị Trấn Bồng Sơn, Huyện Hoài Nhơn, Bình Định"})
        self.assertEqual(contact.additional_infor, {"tags": "tag", "gmail": "nth@gmail.com", "twitter": "nth.twitter", "facebook": "nth.facebook", "linkedln": "nth.linkedln", "interests": [interest.id]})
