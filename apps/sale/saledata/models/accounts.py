...
class Account(TenantModel):
    ...
    name = models.CharField(verbose_name='account_name', null=False, max_length=150)
    code = models.CharField(verbose_name='account_code', blank=True, null=True, max_length=150)
    website = models.CharField(verbose_name='website', blank=True, null=True, max_length=150)
    account_type = models.JSONField(null=False, default=list)
    manager = models.JSONField(null=False)
    parent_account = models.CharField(verbose_name='parent_account', null=True, max_length=150)
    tax_code = models.CharField(verbose_name='text_code', blank=True, null=True, max_length=150)
    industry = models.ForeignKey('saledata.Industry', on_delete=models.CASCADE, null=False)
    annual_revenue = models.CharField(verbose_name='annual_revenue', blank=True, null=True, max_length=150)
    total_employees = models.CharField(verbose_name='total_employees', null=False, max_length=150)
    phone = models.CharField(verbose_name='phone', blank=True, null=True, max_length=25)
    email = models.CharField(verbose_name='email', blank=True, null=True, max_length=150)
